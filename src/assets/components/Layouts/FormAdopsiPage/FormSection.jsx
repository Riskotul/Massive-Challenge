...
const PopUpTerkirim = ({ isPopUpOpen, handlePopUp }) => {
  return (
    ...
    >
      <div className="w-[90%] max-w-[466px] h-[560px] rounded-[20px] bg-white relative border">
        ...
        <div className="mt-[137px] w-full flex flex-col items-center gap-4">
          <h1 className="text-[36px] lg:text-[48px] font-bold">Terkirim</h1>
          <div className="flex flex-col px-4">
            <p className="text-[18px] lg:text-[20px] font-medium text-center">
              Terima kasih telah memberi mereka kesempatan kedua untuk hidup
              bahagia. Untuk informasi selanjutnya, akan kami informasikan lebih lanjut
              melalui email.
            </p>
          </div>
          <button
            onClick={handlePopUp}
            className="size-fit px-[40px] lg:px-[52px] py-3 bg-[#FA9F42] rounded-lg text-white text-[20px] lg:text-[24px] font-medium"
          >
            Kembali
          </button>
        </div>
        ...
        <form className="flex flex-col w-full items-center px-4 lg:px-[38px]">
          ...
          <div className="w-full lg:w-[974px] grid grid-cols-1 lg:grid-cols-2 gap-x-[92px] gap-y-6 mt-6 mb-[50px]">
            {[
              ...
              { label: "Siapa nama hewan yang Anda adopsi?", id: "animal-name" },
            ].map(({ label, id }) => (
          ...
          <div id="section4" className="w-full lg:w-[974px] flex flex-col mt-6 gap-6">
            {[
              {
                label:
          ...
          >
            <h1 className="font-bold text-[24px]">Catatan Tentang Kesehatan Kucing/Anjing</h1>
          </div>
          <div id="section1" className="w-full lg:w-[974px] flex flex-col mt-6 ">
            <div className="flex flex-col gap-[18px]">
              <h1 className="text-[20px] font-reguler  text-justify ">
              Kami tidak bisa menjamin kesehatan hewan yang akan Anda adopsi, 
              tetapi kami akan jujur tentang riwayat penyakit mereka dan menyediakan catatan medis. 
              Adopsi hewan kami disertai dengan rekomendasi untuk pemeriksaan hewan oleh dokter. 
              Meskipun kami percaya hewan kami dalam keadaan sehat, mereka mungkin terpapar penyakit jalanan. 
              Jika hewan menunjukkan gejala penyakit, harap segera konsultasikan dengan dokter dan beri tahu kami. 
              Kami menawarkan masa percobaan adopsi selama dua minggu. 
              Jika penyakit yang sudah ada muncul selama masa percobaan, kami akan menanggung biayanya. 
              Biaya untuk perawatan baru akan menjadi tanggung jawab Anda.
              </h1>
            </div>
            <div className="flex flex-col mt-6">
              <h1 className="text-[20px] font-medium">
                Saya telah membaca, mengerti, dan menyetujui Catatan tentang Kesehatan Kucing/Anjing diatas
              </h1>
              <div className="mt-[18px]">
                {[
                  { id: "yes", label: "Ya" },
          ...
          <div id="section1" className="w-full lg:w-[974px] flex flex-col mt-6 teks-justified">
            <div className="flex flex-col gap-4 px-4 lg:px-8">
              <h1 className="text-[20px] font-reguler">
                <ol className="list-decimal list-inside text-justify space-y-2">
                  <li>Pemindahan Kepemilikan: Pemilik setuju untuk mentransfer kepemilikan hewan kepada Pengadopsi dengan persetujuan bahwa Pengadopsi akan bertanggung jawab atas perawatan dan kesejahteraan hewan tersebut.</li>
                  <li>Perawatan: Pengadopsi setuju untuk memberikan perawatan yang baik dan kasih sayang kepada hewan, termasuk pemberian makan, minum, perawatan medis, dan perlindungan.</li>
                  <li>Kesejahteraan: Pengadopsi akan memastikan bahwa hewan tinggal di lingkungan yang aman dan tidak terisolasi.</li>
                  <li>Kesehatan: Pengadopsi setuju untuk membawa hewan ke dokter hewan secara teratur dan memberikan vaksinasi yang diperlukan.</li>
                  <li>Tanggung Jawab: Pengadopsi bertanggung jawab penuh atas hewan dan setuju untuk tidak menyerahkan, menjual, atau meninggalkan hewan tersebut tanpa persetujuan dari Pemilik.</li>
                  <li>Pemutusan Kontrak: Pemilik berhak untuk membatalkan kontrak dan mengambil kembali hewan jika Pengadopsi melanggar ketentuan kontrak atau tidak mampu lagi merawat hewan tersebut.</li>
                </ol>
              </h1>
            </div>
            <div className="flex flex-col mt-6">
              <h1 className="text-[20px] font-medium">
                Saya mengakui bahwa saya telah membaca dan memahami pemberitahuan kontrak di atas
              </h1>
              <div className="mt-[18px]">
                {[
                  { id: "yes", label: "Ya" },
