const HeroSection = () => {
  return (
    <section className="w-full h-auto lg:h-[433px] bg-[#8DD67A] flex flex-col lg:flex-row justify-center items-center gap-6 lg:gap-12 text-black px-4 lg:px-0 py-8 lg:py-0">
