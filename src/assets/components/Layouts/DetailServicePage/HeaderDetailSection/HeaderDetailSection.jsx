    ...
    <section className="w-[1220px] flex gap-[60px] mt-[77px] relative">
      ...
      <div className="flex flex-col gap-6">
        <div className="w-[550px] h-[408px] rounded-[20px] overflow-hidden relative shadow-400">
          <img
            src="/images/DetailServicePage/detail-img-1.png"
            alt=""
        ...
        <div className="flex gap-[50px]">
          <div className="w-[250px] h-[118px] rounded-[20px] shadow-400">
            {" "}
            <img
              src="/images/DetailServicePage/detail-img-2.png"
              alt=""
              className="object-cover size-full"
            />
          </div>
          <div className="w-[250px] h-[118px] rounded-[20px] shadow-400">
            {" "}
            <img
              src="/images/DetailServicePage/detail-img-3.png"
              alt=""
              className="object-cover size-full"
            />
          </div>
      ...
      <div className="flex flex-col gap-9">
        <h1 className="text-[48px] font-bold">Lucky</h1>
        <div className="flex flex-col gap-[30px]">
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="w-[610px] h-6 rounded-[10px] bg-[#8DD67A] shadow-500">
              <div className="w-[351px] h-full rounded-[10px] bg-[#FA9F42]"></div>
            </div>
          </div>
          <div className="flex flex-col gap-7">
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="w-[610px] h-6 rounded-[10px] bg-[#8DD67A] shadow-500">
              <div className="w-[247px] h-full rounded-[10px] bg-[#FA9F42]"></div>
            </div>
          </div>
        </div>
      </div>
