...
const EditProfilePage = () => {
  ...
  useEffect(() => {
    // Mendapatkan data pengguna saat halaman dimuat
    ...
    <>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mt-6 max-w-7xl w-full mx-auto mt-60 mb-20">
        ...
        <div className="border border-black rounded-lg p-8 relative gap-12">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
            ...
            <div className="form-group flex flex-col">
              <button type="submit" className="bg-[#FA9F42] text-white py-2 px-4 rounded-lg absolute top-4 right-4">
                Simpan
              </button>
            </div>
          </form>
